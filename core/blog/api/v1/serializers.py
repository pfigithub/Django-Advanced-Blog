...
class PostSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Post
        fields = ['id','author','title','image','content','category','status','created_date','published_date']
    ...
    def create(self, validated_date):
        validated_date['author'] = Profile.objects.get(user__id = self.context.get('reqest').user.id)
